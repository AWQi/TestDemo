package com.example.dell.testdemo.floating.floatingactionbutton;
  ...
  */
  ...
  void updateBackground() {
    ...
    LayerDrawable layerDrawable = new LayerDrawable(
        new Drawable[] {
            getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.fab_label_orange : R.drawable.fab_label_background),
